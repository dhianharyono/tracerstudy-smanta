...
const CollegePlan = () => {
  const { user } = useAuth();
  const [activeTab] = useState<'plan' | 'alumni'>('plan');
  ...
  return (
    <div className='p-4 md:p-8 animate-fade-in'>
      ...
      {/* Tabs */}
      {/* <div className='flex p-1 bg-gray-100 dark:bg-gray-800 rounded-xl mb-8 w-fit mx-auto md:mx-0'>
        <button
          onClick={() => setActiveTab('plan')}
          className={`px-4 py-2 rounded-lg text-sm font-bold transition-all ${activeTab === 'plan'
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-bold transition-all ${activeTab === 'alumni'
              ? 'bg-white dark:bg-gray-700 text-[var(--primary)] shadow-sm'
              : 'text-[var(--text-tertiary)] hover:text-[var(--text-secondary)]'
            }`}
        >
                  ...
                  <div className='pt-6 border-t border-[color:var(--border-color)]'>
                    ...
                    <div className='p-4 bg-amber-50 dark:bg-amber-500/5 rounded-2xl border border-amber-100 dark:border-amber-500/10'>
                      <p className='text-[10px] leading-relaxed text-amber-800 dark:text-amber-300'>
                        ...
                        memiliki <strong>kontak sosial media</strong> adalah
                        Mentor yang bersedia membimbing Anda secara langsung.
                      </p>
                    </div>
                  </div>
                  <div>
                    ...
                    <div className='p-4 bg-blue-50 dark:bg-blue-500/5 rounded-2xl border border-blue-100 dark:border-blue-500/10'>
                      <p className='text-[10px] leading-relaxed text-blue-800 dark:text-blue-300'>
                        <span className='font-bold flex items-center gap-1'>
                          Alumni dengan Badge adalah alumni yang telah
                          terverifikasi memiliki prestasi atau kontribusi khusus
                          pada Expo Campus.
                        </span>
                      </p>
                    </div>
              ...
              !selectedBadge ? (
                <div className='h-[500px] flex flex-col items-center justify-center text-center p-8 bg-[color:var(--bg-card)] rounded-3xl border border-[color:var(--border-color)] shadow-sm'>
                  ...
                  <p className='text-[color:var(--text-secondary)] max-w-sm'>
                    Gunakan filter untuk melihat daftar alumni yang pernah
