              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-10 items-start'>
                <div className='space-y-4'>
                  <p className='text-sm md:text-lg text-[color:var(--text-secondary)] leading-relaxed italic border-l-4 border-blue-500/30 pl-6'>
                    "Masa transisi setelah SMA adalah persimpangan jalan yang
                    menantang. Tanpa data yang terintegrasi, siswa seringkali
                    melangkah tanpa arah, sementara hubungan berharga dengan
                    alumni terputus begitu saja."
                  </p>
                </div>
                <div className='space-y-6'>
                  <p className='text-sm md:text-lg font-medium text-[color:var(--text-primary)] leading-relaxed'>
                    ...
                    , memastikan setiap jejak alumni menjadi inspirasi dan
                    panduan nyata bagi adik-adik yang akan menyusul ke jenjang
                    berikutnya.
                  </p>
        ...
        <div className='max-w-7xl mx-auto'>
          ...
          >
            ...
            <p className='text-sm md:text-base text-[color:var(--text-secondary)] max-w-2xl mx-auto'>
              Dirancang untuk memudahkan interaksi dan memberikan manfaat nyata
              bagi seluruh warga dan Alumni SMANTA.
            </p>
          </motion.div>
