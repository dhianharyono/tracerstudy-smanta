      ...
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10'>
          ...
          <motion.div
            ...
            className='bg-[color:var(--bg-card)] p-6 md:p-8 rounded-[30px] md:rounded-[40px] border border-[color:var(--border-color)] shadow-xl relative overflow-hidden group'
          >
              ...
              <ul className='space-y-4 md:space-y-5'>
                {[
                  ...
                  },
                  {
                    ...
                    desc: 'Cari dan dapatkan informasi lowongan kerja yang sesuai dengan kualifikasi Anda.',
                  },
                ].map((f, i) => (
                  <li key={i} className='flex gap-4 group/item'>
          ...
          <motion.div
            ...
            className='bg-[color:var(--bg-card)] p-6 md:p-8 rounded-[30px] md:rounded-[40px] border border-[color:var(--border-color)] shadow-xl relative overflow-hidden group md:col-span-2 lg:col-span-1'
          >
            ...
            <div className='relative z-10'>
              <div className='flex items-center gap-4 mb-8'>
                <div className='w-12 h-12 md:w-14 md:h-14 bg-emerald-500/10 rounded-2xl flex items-center justify-center text-emerald-500 shadow-inner'>
              ...
              <ul className='space-y-4 md:space-y-5'>
                {[
                  ...
                  {
                    title: 'Validasi Data',
                    desc: 'Verifikasi kevalidan data alumni untuk keperluan administrasi sekolah.',
                  },
                  {
                  ...
                  <li key={i} className='flex gap-4 group/item'>
                    <div className='mt-1.5 w-2 h-2 rounded-full bg-emerald-500 shrink-0 group-hover/item:scale-125 transition-transform'></div>
                    <div>
                      <p className='text-sm md:text-base font-bold text-[color:var(--text-primary)] mb-0.5'>
                        {f.title}
                      </p>
