...
import { FaSave, FaPaperPlane, FaStar, FaSpinner, FaCommentDots } from 'react-icons/fa';
...
const FeedbackForm: React.FC<FeedbackFormProps> = ({ role }) => {
    ...
    const renderStar = (index: number) => {
        ...
        const colorClass = isFilled ? 'text-yellow-400' : 'text-gray-300 dark:text-gray-600';
        ...
        return (
            ...
            >
                <FaStar className={`text-3xl md:text-4xl transition-colors duration-200 ${colorClass}`} />
            </button>
        );
    };
        ...
        <div className='p-4 md:p-8 animate-fade-in'>
            ...
            <div className='rounded-2xl border border-[color:var(--border-color)] bg-[color:var(--bg-card)] p-6 md:p-8 shadow-lg'>
                <div className='mb-6 flex items-center gap-3 border-b border-[color:var(--border-color)] pb-4'>
                    ...
                    <h2 className='text-xl font-bold text-[color:var(--text-primary)] !mb-0'>Formulir Masukan</h2>
                </div>
                ...
                <div className='mb-8 text-center'>
                    ...
                    {feedback.rating > 0 && (
                        <div className='inline-block rounded-full bg-blue-50 px-4 py-1 text-sm font-medium text-blue-700 dark:bg-blue-900/20 dark:text-blue-300'>
